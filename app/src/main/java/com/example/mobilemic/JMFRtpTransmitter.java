...
import com.sun.media.protocol.BasicPullBufferDataSource;
...
public class JMFRtpTransmitter {
    ...
    public JMFRtpTransmitter(MediaLocator locator,String ipAddress,
                     String port) {
    ...
    private String createTransmitter() {
        ...
        try {
            ...
            Vector devices = CaptureDeviceManager.getDeviceList( new AudioFormat(AudioFormat.LINEAR, 8000, 8, 1));
